      ...
      <div className="container mx-auto px-4 max-w-5xl space-y-16">
        ...
        <div className="bg-slate-900 text-white p-4 rounded-2xl flex flex-wrap items-center justify-between gap-3 shadow-lg border border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="font-bold text-sm text-white block">Interactive Report Editor</span>
              <span className="text-xs text-slate-400">Click edit to type your real user feedback directly into this report</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {isEditing ? (
              <>
                <button
                  onClick={handleSave}
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold rounded-xl text-xs transition flex items-center gap-1.5 shadow-sm"
                >
